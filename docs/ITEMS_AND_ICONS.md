...
pulse oximeter loot. (The brains are gone entirely, `docs/GRAFTING_TRACHEA.md`.) Remove them from
`scripts/economy/loot_table.gd`, their models from
...
- **Pay:** (superseded) a shift once had to pay within about 10% of before. Loot is now scarce on
  purpose: 15 to 20 stacks and about $1,000 a shift, so a harvested body part is a real share of the pay.
