...
func _consume_actions() -> void:
	...
	var busy := downed or carrying != 0 or dragging_monster >= 0 or puppeting or held_by >= 0 or pushing_gurney()   # SWEEP 3 HOOK (combat: dragging; helpless while puppeting); the Nurse's grab
