...
Nothing downloaded. The Echo and Hive Eyes screens are built from code. The sounds
`audio/sfx/brains_*.wav` are synthesized by `tools/gen_audio_brains.mjs` (deterministic, no
samples).
